...
Like bug reports, first search through both issues and discussions and try to find if your feature has already been requested. Otherwise, open a discussion in the ["Feature Requests, Ideas"](https://github.com/dlvhdr/gh-enhance/issues/new?template=feature_request.md) category.
...
Open a [Q&A discussion](https://github.com/dlvhdr/gh-enhance/discussions/categories/q-a), or join our [Discord Server](https://discord.gg/SXNXp9NctV) and ask away in the #help forum channel.
...
```sh
git clone git@github.com:dlvhdr/gh-enhance.git && cd gh-enhance
```
...
- Run `enhance` in debug mode with `task debug` in another terminal window / pane
